...
- Access / disposition: still thin at time of draft (KF-12 model now accepted)
...
| ISO 15489 | Authenticity, capture, classification | Agent authority boundary, uncertainty preservation | Retention / legal-hold (model accepted; enforcement later) |
