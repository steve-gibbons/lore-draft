...
|----|---------|--------|----------|-------------|
| KF-01 | Trust boundaries are **declarative, not authenticated** (author-only status, agent-vs-author, identity all self-asserted) | P1·P2·P3·P4·C6 | **Major** | 🟡 fast-follower · ✅ approach decided (`DECISION-AUTH-IDENTITY.accepted.md` - Option C layered); build open |
